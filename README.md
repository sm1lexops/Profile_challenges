...
* В примеры правил безопасности первоначально я бы использовал OWASP CRS, отсекая не релевантные для приложения и дополняя цепочки правил согласно лучшим практикам и тестам
